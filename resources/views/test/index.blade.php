...
<head>
        ...
        <!-- Icon css link -->
        <link href="{{ asset('cakeassets/css/font-awesome.min.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/linearicons/style.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/flat-icon/flaticon.css') }}" rel="stylesheet">
        <!-- Bootstrap -->
        <link href="{{ asset('cakeassets/css/bootstrap.min.css') }}" rel="stylesheet">

        <!-- Rev slider css -->
        <link href="{{ asset('cakeassets/vendors/revolution/css/settings.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/revolution/css/layers.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/revolution/css/navigation.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/animate-css/animate.css') }}" rel="stylesheet">

        <!-- Extra plugin css -->
        <link href="{{ asset('cakeassets/vendors/owl-carousel/owl.carousel.min.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/vendors/magnifc-popup/magnific-popup.css') }}" rel="stylesheet">

        <link href="{{ asset('cakeassets/css/style.css') }}" rel="stylesheet">
        <link href="{{ asset('cakeassets/css/responsive.css') }}" rel="stylesheet">

        <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
        <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
        <!--[if lt IE 9]>
        <script src="https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
        <script src="blogassets/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
        <![endif]-->
    </head>
    <body>
			...
			<div class="main_menu_area">
				<div class="container">
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						...
						<img src="{{ asset('blogassets/img/logo.png') }}" alt="">
						<img src="{{ asset('blogassets/img/logo-2.png') }}" alt="">
						</a>
        ...
        <section class="main_slider_area">
            <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                <ul>
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('blogassets/img/home-slider/slider-1.jpg') }}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('blogassets/img/home-slider/slider-2.jpg') }}"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                        <!-- LAYERS -->
        			...
        			<div class="row">
        				...
        				<div class="col-lg-6">
        					<div class="welcome_img">
        						<img class="img-fluid" src="{{ asset('blogassets/img/cake-feature/welcome-right.jpg') }}" alt="">
        					</div>
        				</div>
        			</div>
        		</div>
       				...
       				<div class="cake_feature_slider owl-carousel">
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="{{ asset('blogassets/img/cake-feature/c-feature-1.jpg') }}" alt="">
       							</div>
       							<div class="cake_text">
       								<h4>$29</h4>
       					...
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="{{ asset('blogassets/img/cake-feature/c-feature-2.jpg') }}" alt="">
       							</div>
       							<div class="cake_text">
       								<h4>$29</h4>
       								<h3>Strawberry Cupcakes</h3>
       					...
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="{{ asset('blogassets/img/cake-feature/c-feature-3.jpg') }}" alt="">
       							</div>
       							<div class="cake_text">
       								<h4>$29</h4>
       								<h3>Strawberry Cupcakes</h3>
       					...
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="{{ asset('blogassets/img/cake-feature/c-feature-4.jpg') }}" alt="">
       							</div>
       							<div class="cake_text">
       								<h4>$29</h4>
       								<h3>Strawberry Cupcakes</h3>
        	...
        	<div class="container">
        		<div class="special_recipe_slider owl-carousel">
        			<div class="item">
        				<div class="media">
        					<div class="d-flex">
        						<img src="{{ asset('blogassets/img/recipe/recipe-1.png') }}" alt="">
        					</div>
        		...
        		<div class="client_says_inner">
        			...
        			<div class="client_says_slider owl-carousel">
        				<div class="item">
        					<div class="media">
        						<div class="d-flex">
        							<img src="{{ asset('blogassets/img/client/client-1.png') }}" alt="">
        							<h3>“</h3>
        						</div>
        						<div class="media-body">
        	...
        	<div class="container">
        		<div class="row our_chef_inner">
        			...
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					<div class="chef_img">
        						<img class="img-fluid" src="{{ asset('blogassets/img/chef/chef-1.jpg') }}" alt="">
        						<ul class="list_style">
        							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
        			...
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					<div class="chef_img">
        						<img class="img-fluid" src="{{ asset('blogassets/img/chef/chef-2.jpg') }}" alt="">
        						<ul class="list_style">
        							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
        							<li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
        							<li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
        			...
        			<div class="col-lg-3 col-6">
        				<div class="chef_item">
        					<div class="chef_img">
        						<img class="img-fluid" src="{{ asset('blogassets/img/chef/chef-3.jpg') }}" alt="">
        						<ul class="list_style">
        							<li><a href="#"><i class="fa fa-twitter"></i></a></li>
        							<li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
        							<li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
       			...
       			<div class="row latest_news_inner">
       				<div class="col-lg-4 col-md-6">
       					<div class="l_news_image">
       						<div class="l_news_img">
       							<img class="img-fluid" src="{{ asset('blogassets/img/blog/latest-news/l-news-1.jpg') }}" alt="">
       						</div>
       				...
       				<div class="col-lg-4 col-md-6">
       					<div class="l_news_item">
       						<div class="l_news_img">
       							<img class="img-fluid" src="{{ asset('blogassets/img/blog/latest-news/l-news-2.jpg') }}" alt="">
       						</div>
       				...
       				<div class="col-lg-4 col-md-6">
       					<div class="l_news_item">
       						<div class="l_news_img">
       							<img class="img-fluid" src="{{ asset('blogassets/img/blog/latest-news/l-news-3.jpg') }}" alt="">
       						</div>
       						<div class="l_news_text">
       							<a href="#"><h5>Oct 15, 2016</h5></a>
       							<a href="#"><h4>Nanotechnology immersion along the information</h4></a>
        			...
        			<div class="row footer_wd_inner">
        				<div class="col-lg-3 col-6">
        					<aside class="f_widget f_about_widget">
        						<img src="{{ asset('blogassets/img/footer-logo.png') }}" alt="">
        ...
        <script src="{{ asset('blogassets/js/jquery-3.2.1.min.js') }}"></script>
        <!-- Include all compiled plugins (below), or include individual files as needed -->
        <script src="{{ asset('blogassets/js/popper.min.js') }}"></script>
        <script src="{{ asset('blogassets/js/bootstrap.min.js') }}"></script>
        <!-- Rev slider js -->
        <script src="{{ asset('blogassets/cakeassets/vendors/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
        <script src="{{ asset('blogassets/cakeassets/vendors/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/revolution/js/extensions/revolution.extension.actions.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/revolution/js/extensions/revolution.extension.video.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
        <!-- Extra plugin js -->
        <script src="{{ asset('blogassets/vendors/owl-carousel/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/magnifc-popup/jquery.magnific-popup.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/datetime-picker/js/moment.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/datetime-picker/js/bootstrap-datetimepicker.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/nice-select/js/jquery.nice-select.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/jquery-ui/jquery-ui.min.js') }}"></script>
        <script src="{{ asset('blogassets/vendors/lightbox/simpleLightbox.min.js') }}"></script>

        <script src="{{ asset('blogassets/js/theme.js') }}"></script>
    </body>
